...
<html>
    ...
    <head>
        ...
        <script src="../scripts/classifica.js"></script>
        ...
        <style>
            ...
            table {
                ...
                margin: 20px auto; /* Imposta il margine automatico per centrare la tabella */
    ...
    <body>
        ...
        <main id="main_mainPage">
            <h1 style="text-align:center;">CLASSIFICA DEI GP PASSATI</h1>

            <div id="gara"></div> <!--informazioni della gara: nome circuito, giri, meteo-->

            <div id="classifica"></div> <!--classifica: nome, cognome-->
