...
<html>
    ...
    <body>
        ...
        <main>
            <div>
                <a href="generic_news"><input type="button" value="<--"></a>  <!--per rimandarmi alla pagina delle notizie -->
            </div>

            <div>
                <h1>How drivers stay healthy during the season</h1>
                <p>At the 2023 Abu Dhabi Grand Prix, after claiming his second top-three finish of the season, 
                    <br> George Russell, looking visibly weary, walked onto the podium above.... 
                    <br> shdfhsbhfshfshfshdsjhdsfhsfhshvbshvbsbvhsdbvhsbvhsbvhsbvhsbvhbshvbshbhvbshbshdb 
                    <br> shdfhsbhfshfshfshdsjhdsfhsfhshvbshvbsbvhsdbvhsbvhsbvhsbvhsbvhbshvbshbhvbshbshdb
                    <br> shdfhsbhfshfshfshdsjhdsfhsfhshvbshvbsbvhsdbvhsbvhsbvhsbvhsbvhbshvbshbhvbshbshdb
                    <br> shdfhsbhfshfshfshdsjhdsfhsfhshvbshvbsbvhsdbvhsbvhsbvhsbvhsbvhbshvbshbhvbshbshdb
                    <br> shdfhsbhfshfshfshdsjhdsfhsfhshvbshvbsbvhsdbvhsbvhsbvhsbvhsbvhbshvbshbhvbshbshdb
                ...
                <a href="https://www.formula1.com/en/latest/article.fit-for-f1-how-drivers-stay-healthy-during-the-season.5A1pZLIY8p3UXLpQ3etDVY.html" target="_blank">per saperne di più </a>
